...
const ComposeMail = ({ open, setOpenDrawer }) => {
    ...
    const config = {
        Username: "vivekproject@yopmail.com",
        Password: "F2F6516ADB028689C69D28E5492D297BA419",
    ...
    const sendEmail = async (e) => {
        ...
        if (window.Email) {
            window.Email.send({
                ...config,
                To : data.to,
                From : "viveksharma28402@gmail.com",
        ...
        const payload = {
            to : data.to,
            from : "vivekkumar.117942@marwadiuniversity.ac.in",
            subject : data.subject,
            body : data.body,
            date: new Date(),
            image: '',
    ...
    const closeComposeMail = (e) => {
        ...
        const payload = {
            ...
            date: new Date(),
            image: '',
            name: 'vivek sharma gmail project',
            starred: false,
            type: 'drafts'
        }
